...
query1=$(/usr/bin/snmpget -m '' -v 2c -c "${PASSWORD}" $NODE 1.3.6.1.4.1.77.1.2.3.1.1.24.77.105.99.114.111.115.111.102.116.32.69.120.99.104.97.110.103.101.32.73.77.65.80.52)
